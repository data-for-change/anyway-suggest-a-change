...
export const REDIRECT_ROUTE: string | undefined = import.meta.env.VITE_REDIRECT_URL;
...
export const showOnlyOperCards = import.meta.env.VITE_SHOW_ONLY_OPER_CARDS === 'true';
