...
import AnyWayCard, {
  CardSizeOptions,
} from "components/molecules/card/AnyWayCard";
import {
  MetaTag,
  ErrorBoundary,
  Typography,
...
import {
  initEditorBarOptions,
  barsWidgetsLabels,
  barsWidgetsTitle,
  NUM_OF_BARS,
} from "utils/barChart.utils";
            ...
            <Box mt={2} display="flex" flexDirection="column">
              ...
              <FormGroup>
                {Array.from({ length: NUM_OF_BARS }, (_, i) => {
                  return (
                    <FormControlLabel
                      label={t(barsWidgetsLabels[widgetName][i])}
                      control={
                        <Checkbox
                          defaultChecked
                          style={{ color: blueVioletColor }}
