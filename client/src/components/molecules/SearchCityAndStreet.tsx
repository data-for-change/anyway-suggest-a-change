...
const SearchCityAndStreet: FC<ISearchCityAndStreet> = ({
  onStreetAndCityChoice,
}) => {
  ...
  async function setCityGetStreets(
    event: ChangeEvent<{}>,
    value?: ICityOption | null
  ) {
    setStreetsOptions([]);
    setStreetValue({});
    if (value) {
      setCityValue({
        yishuv_name: value.yishuv_name,
        yishuv_symbol: value.yishuv_symbol,
      });
  ...
  function setChosenStreet(
    event: ChangeEvent<{}>,
    value?: IStreetOption | null
  ) {
    if (value) {
  ...
  return (
    <Box display="flex" flexWrap="wrap">
      <Autocomplete
        ...
        value={{
          yishuv_name: cityValue.yishuv_name,
          yishuv_symbol: cityValue.yishuv_symbol,
        }}
        style={{ minWidth: 300 }}
        renderInput={(params) => (
          <TextField
      ...
      <Autocomplete
        ...
        value={{
          ...
          street_hebrew: streetValue.street_hebrew,
        }}
