...
const UserInfoForm: React.FC<IProps> = ({
  ...
  const [validations, setValidations] =
    useState<IValidationErrors>(initialValidations);
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        >
          <Grid item xs={6}>
            ...
            <FormHelperText
              error
              className={!validations.lastName ? "" : classes.hide}
            >
          ...
          <Grid item xs={6}>
            ...
            <FormHelperText
              error
              className={!validations.firstName ? "" : classes.hide}
            >
          ...
          <Grid item xs={12}>
            ...
            <FormHelperText
              error
              className={!validations.email ? "" : classes.hide}
            >
          ...
          <Grid item xs={12}>
            <Box className={classes.submitButton}>
              <Button.Standard isSubmit>
                {t(`userDetailsForm.Update`)}
              </Button.Standard>
            </Box>
          </Grid>
        </Grid>
