...
const ApproveLocationRadioButtons: FC<IProps> = ({
  handleApproveStatusChange,
  defaultValue,
}) => {
  ...
  const checkedApproveIcon = (
    <CheckCircleIcon fill={oceanBlueColor} className={classes.icon} />
  );
  const uncheckedApproveIcon = (
    <CheckCircleIcon fill={silverGrayColor} className={classes.icon} />
  );
  const checkedRejectIcon = (
    <CancelCircleIcon fill={roseColor} className={classes.icon} />
  );
  const uncheckedRejectIcon = (
    <CancelCircleIcon fill={silverGrayColor} className={classes.icon} />
  );
    ...
    <FormControl>
      ...
      >
        <FormControlLabel
          ...
          control={
            <Radio
              checkedIcon={checkedApproveIcon}
              icon={uncheckedApproveIcon}
            />
          }
        ...
        <FormControlLabel
          value="reject"
          control={
            <Radio checkedIcon={checkedRejectIcon} icon={uncheckedRejectIcon} />
          }
