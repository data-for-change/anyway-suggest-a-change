...
const MostSevereAccidentsMarker: FC<IProps> = ({
  data,
  tooltipOffset = ClockPosition.LEFT,
}) => {
  ...
  const icon: L.Icon = MapIcon.getIconBySeverity(
    "carIcon",
          ...
          <Popup className={classes.root}>
            ...
            <div className={classes.arrowContainer}>
              <AnyWayButton
                ...
                onClick={setOffset.bind(null, ClockPosition.TOPRIGHT)}
              >
                <TooltipArrow type={ClockPosition.TOPRIGHT} />
              </AnyWayButton>
              <AnyWayButton
                className={classes.button}
                onClick={setOffset.bind(null, ClockPosition.TOP)}
              >
                <TooltipArrow type={ClockPosition.TOP} />
              </AnyWayButton>
              <AnyWayButton
                className={classes.button}
                onClick={setOffset.bind(null, ClockPosition.TOPLEFT)}
              >
            ...
            <div className={classes.arrowContainer}>
              <AnyWayButton
                className={classes.button}
                onClick={setOffset.bind(null, ClockPosition.RIGHT)}
              >
              ...
              <AnyWayButton
                className={classes.button}
                onClick={setOffset.bind(null, ClockPosition.LEFT)}
              >
            ...
            <div className={classes.arrowContainer}>
              <AnyWayButton
                className={classes.button}
                onClick={setOffset.bind(null, ClockPosition.BOTTOMRIGHT)}
              >
                <TooltipArrow type={ClockPosition.BOTTOMRIGHT} />
              </AnyWayButton>
              <AnyWayButton
                className={classes.button}
                onClick={setOffset.bind(null, ClockPosition.BOTTOM)}
              >
                <TooltipArrow type={ClockPosition.BOTTOM} />
              </AnyWayButton>
              <AnyWayButton
                className={classes.button}
                onClick={setOffset.bind(null, ClockPosition.BOTTOMLEFT)}
              >
