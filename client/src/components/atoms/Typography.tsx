...
const TypographyBase: FC<ITypographyBase> = ({
  bold,
  variant,
  component,
  children,
...
const Typography: IText = {
  Title1: (props) => (
    <TypographyBase variant="subtitle1" component="h2" {...props} />
  ),
  Title2: (props) => (
    <TypographyBase variant="subtitle2" component="h3" {...props} />
  ),
